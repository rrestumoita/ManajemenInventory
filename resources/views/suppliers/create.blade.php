    ...
    <form action="{{ route('tambah') }}" method="post" enctype="multipart/form-data" class="p-2">
        ...
        <div class="mx-5 mb-3">
            <div class="mb-3">
                ...
                <div class="mt-2">
                    <input type="text" name="namaPerusahaan" id="namaPerusahaan" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Nama Perusahaan" required></input>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="mt-2">
                    <input type="text" name="alamatPerusahaan" id="alamatPerusahaan" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Alamat Perusahaan" required></input>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="mt-2">
                    <input type="text" name="noTelepon" id="noTelepon" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="No. Telepon" required></input>
                </div>
                @error('noTelepon')
                <div>
                    <p class="text-red-500 text-base">{{ $message }}</p>
