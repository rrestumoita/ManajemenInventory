 ...
 method="post" enctype="multipart/form-data" class="p-2">
        ...
        <div class="mx-5 mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="kategori" id="kategori" cols="30" rows="10" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 text-white focus:ring-blue-500 focus:border-blue-500" required>{{ $product->kategori }}</textarea>
                @error('kategori')
                    <div>
                        <p class="text-red-500 text-base">{{ $message }}</p>
                    </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="harga" id="harga" cols="30" rows="10" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 text-white focus:ring-blue-500 focus:border-blue-500" required>{{ $product->harga }}</textarea>
                @error('harga')
                    <div>
                        <p class="text-red-500 text-base">{{ $message }}</p>
                    </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="stok" id="stok" cols="30" rows="10" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 text-white focus:ring-blue-500 focus:border-blue-500" required>{{ $product->stok }}</textarea>
                @error('stok')
                    <div>
                        <p class="text-red-500 text-base">{{ $message }}</p>
                    </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="lokasi" id="lokasi" cols="30" rows="10" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 text-white focus:ring-blue-500 focus:border-blue-500" required>{{ $product->lokasi }}</textarea>
                @error('lokasi')
                    <div>
                        <p class="text-red-500 text-base">{{ $message }}</p>
                    </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="keterangan" id="keterangan" cols="30" rows="10" class="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 text-white focus:ring-blue-500 focus:border-blue-500" required>{{ $product->keterangan }}</textarea>
                @error('keterangan')
                    <div>
                        <p class="text-red-500 text-base">{{ $message }}</p>
                    </div>
